package am.gitc.proxyies;

import am.gitc.advices.SimpleBeforeAdvice;
import am.gitc.model.GrammyGuitarist;
...
public class ComposablePointcutExample {
    ...
    private static GrammyGuitarist getProxy(
            ComposablePointcut pe, GrammyGuitarist target) {
        Advisor advisor = new DefaultPointcutAdvisor(pe, new SimpleBeforeAdvice());
